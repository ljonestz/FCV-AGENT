...
def repair_lens_diagnostic(
    ...
    prompt = (
        ...
        'grounded two-paragraph text) surfacing only the material ones, an '
        'optional less_central line, and separate sensitivity_evidence and '
        'responsiveness_evidence lists. Write each reflection text as two solid '
        'plain-language paragraphs that land a decision-relevant point for a '
