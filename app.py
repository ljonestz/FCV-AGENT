...
_REQUIRED_PRIORITY_FIELDS = [
    ...
    'pad_sections', 'implementation_note', 'cpf_alignment', 'rra_driver_alignment',
...
- Each priority JSON object has all 17 fields: title, fcv_dimension, tag, refresh_shift, risk_level, the_gap, why_it_matters, actions, who_acts, when, action_timing, resources, pad_sections, country_category_relevance, implementation_note, cpf_alignment, rra_driver_alignment
