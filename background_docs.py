...
- Why it matters: reference ESSA Core Principle #6 (OPS5.04-POL.125 para 9(f)) as the governing standard, not an ESF community-health-and-safety standard
- Actions: map to PAP commitments strengthening SEA/SH prevention/response within the borrower's own systems, and GRM design through the ESMS
