...
- **v9.23** - Climate-FCV country-bank runtime grounding (branch `feat/climate-country-bank`, 2026-07-31):
  ...
  - South Sudan is the initial single-country pilot candidate. It remains `reviewed`, not `approved`, so it is absent from `releases/current/runtime.json` pending human release.
...
**Current version:** FCV Project Screener v9.23
