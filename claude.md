...
- **v9.18** - Sector-lens diagnostic recovery reliability (2026-07-22):
  - Missing or incomplete active-lens Stage 2 diagnostics trigger one dedicated Haiku recovery request. Its client has a 120-second total timeout, a 10-second connect timeout, and zero SDK retries.
...
**Current version:** FCV Project Screener v9.18
