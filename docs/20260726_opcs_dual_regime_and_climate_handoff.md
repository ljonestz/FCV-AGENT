...
- Preparation regime: OIS creation date vs **17 Apr 2026 for IPF/PforR and 18 Apr 2026 for DPF** → new (OIS→TD→IR / One Review; Project Paper/Program Paper; DPF keeps Program Document) vs legacy (PCN/PID/PAD/Decision Review). One/two-step risk-driven (FCV ⇒ usually two-step). AF routes by own OIS; restructuring bypasses; MPA phases route individually.
