...
> **Completed on 2026-08-25.** All five tasks were implemented and verified on
> `codex/climate-summary-quality-fixes`. The release-candidate head is `789825d` and
> remains separate from `main`. Final evidence, deployment identifiers, artifact paths,
> and analytical caveats are recorded in
...
- [x] **Step 1: Write failing realistic OOXML tests**
...
- [x] **Step 3: Implement the minimal shared traversal**
...
- [x] **Step 5: Commit the extraction checkpoint**
...
- [x] **Step 1: Write failing schema, pipeline, and reader tests**
...
- [x] **Step 3: Extend the existing one-call contract and reader normalization**
...
- [x] **Step 5: Commit the synthesis checkpoint**
...
- [x] **Step 1: Write failing backend and frontend contract tests**
...
- [x] **Step 3: Implement the minimal canonical rendering changes**
...
- [x] **Step 5: Commit the Climate reader checkpoint**
...
- [x] **Step 1: Write failing normal-FCV disclosure tests**
...
- [x] **Step 3: Add the minimal disclosure without changing narrative generation**
...
- [x] **Step 5: Commit the normal-FCV checkpoint**
...
- [x] **Step 1: Update maintained architecture documentation**
...
- [x] **Step 4: Run fresh South Sudan PCN Climate and normal-FCV smoke checks**
...
- [x] **Step 5: Perform browser and export QA**
...
- [x] **Step 6: Final review, commit, push, deploy, and deployed smoke**
