...
**Status:** Completed on `codex/climate-summary-quality-fixes` through `012eaa2`
(2026-08-22). See
[`docs/20260822_ITS_handover_normal_fcv_summary.md`](../../20260822_ITS_handover_normal_fcv_summary.md)
for the delivered contract, live acceptance record, artifacts, and ITS parity notes.

Implementation used this plan task-by-task. The final prompt assembly emits the
Stage 3 JSON first, and restoration persists the concise readout, priorities, and
ratings together so the Summary capability gate can be evaluated after recovery.
Final verification: `1012 passed`.
...
- [x] **Step 3: Implement minimal normalizers**
...
- [x] **Step 3: Add the prompt contract and lifecycle helper**
...
- [x] **Step 3: Add the field to Stage 3 only**
...
- [x] **Step 3: Add state and capability gates**
...
- [x] **Step 4: Render the overall assessment**
...
- [x] **Step 3: Implement controlled wording**
...
- [x] **Step 4: Implement the single-open accordion**
...
- [x] **Step 3: Persist normalized state only**
...
- [x] **Step 1: Update the local parity log**
...
- [x] **Step 3: Run climate and deployment regressions**
...
- [x] **Step 5: Commit test-only corrections only if needed**
